...
public class SigEventAutoGenSpout extends BaseRichSpout {
    public static Logger LOG = LoggerFactory.getLogger(SigEventAutoGenSpout.class);
    boolean _isDistributed;
    SpoutOutputCollector _collector;


	public SigEventAutoGenSpout() {
        this(true);
    }

    public SigEventAutoGenSpout(boolean isDistributed) {
