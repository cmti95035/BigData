...
featureFile <- "output/feature.csv"
clusterFile <- "output/cluster.csv"
...
write.table(finalRes,file="output/gotomap.csv",sep=',',col.names=c("Latitude","Longitude","Cluster"),row.names=FALSE)
